...
public class DevolucionDispatchActions {
	...
	public DevolucionForm cargaInicial(DevolucionForm formulario, DevolucionHelper helper, String local, Session session){		
	...
	public void resetSession(DevolucionForm formulario, Session session){
	...
	public DevolucionForm cargaFormulario(DevolucionForm form, Session request)
	{
	...
	public DevolucionForm IngresaEntregaDesdePedido(DevolucionForm form, Session request) {
		...
		this.cargaAlbaran(formulario, session);
		formulario.setEstaGrabado(2);
	...
	public DevolucionForm cargaAlbaran(DevolucionForm form,	Session request)
	{
	...
	public DevolucionForm cargaBuscarAlbaran(DevolucionForm form, Session request)
	{
		DevolucionForm formulario = (DevolucionForm)form;
		DevolucionHelper helper = new DevolucionHelper();
		//HttpSession session = request.getSession();
	...
	public DevolucionForm buscarAlbaran(DevolucionForm form, Session request)
	{
		DevolucionForm formulario = (DevolucionForm)form;
		DevolucionHelper helper = new DevolucionHelper();
		//HttpSession session = request.getSession();
	...
	public DevolucionForm mostrarListaAlbaranes(DevolucionForm form, Session request)
	{
		DevolucionForm formulario = (DevolucionForm)form;
		DevolucionHelper helper = new DevolucionHelper();
		//HttpSession session = request.getSession();
	...
	public DevolucionForm generaCobroAlbaran(DevolucionForm form, Session request)
	{
		DevolucionForm formulario = (DevolucionForm)form;
		DevolucionHelper helper = new DevolucionHelper();
		//HttpSession session = request.getSession();
	...
	public DevolucionForm cargaAlbaranBuscado(DevolucionForm form, Session request)
	{
		DevolucionForm formulario = (DevolucionForm)form;
		DevolucionHelper helper = new DevolucionHelper();
		//HttpSession session = request.getSession();
	...
	public DevolucionForm cambioAlbaran(DevolucionForm form, Session request)
	{
		DevolucionForm formulario = (DevolucionForm)form;
		DevolucionHelper helper = new DevolucionHelper();
		//HttpSession session = request.getSession();
	...
	public DevolucionForm realizaDevolucion(DevolucionForm form, Session request)
	{
		DevolucionForm formulario = (DevolucionForm)form;
		DevolucionHelper helper = new DevolucionHelper();
		//HttpSession session = request.getSession();
	...
	public Boolean validaCajaAjax(DevolucionForm form, Session request)
	{
		DevolucionForm formulario = (DevolucionForm)form;
		DevolucionHelper helper = new DevolucionHelper();
		//HttpSession session = request.getSession();
	...
	public int validaFechaNC(DevolucionForm form, Session request) throws IOException
	{
		DevolucionForm formulario = (DevolucionForm)form;
		DevolucionHelper helper = new DevolucionHelper();
		int res = 0;
