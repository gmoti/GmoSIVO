...
public class BusquedaProductosHelper extends Utils{
	...
	public boolean visualizaBusquedaAvanzada(BusquedaProductosForm formulario, String form_origen, Session session, String familia) {
	...
	public void traeGraduacionesClientes(BusquedaProductosForm formulario, Session session) 
	{
	...
	public void traeProductosGraduados(BusquedaProductosForm formulario, Session session) {
	...
	public void traeProductosGraduadosMulti(BusquedaProductosForm formulario, Session session) {
		log.info("BusquedaProductosHelper:traeProductosGraduados inicio");
	...
	public boolean compruebaBusquedaPorCodigo(BusquedaProductosForm formulario, String local, String form_origen, boolean busqueda_avanzada_lentilla, Session session) {
	 ...
	 */
	public void verSuplementosProductoMultioferta(BusquedaProductosForm formulario, Session session) {
	...
	public void cargaListaProductosMultioferta(BusquedaProductosForm formulario, Session session) {
	...
	public void agregaSuplementosProductoMultioferta(BusquedaProductosForm formulario, Session session) {
	...
	public void modificaGrupoMultioferta(BusquedaProductosForm formulario, int index, String grupo, Session session) {		
	...
	public boolean visualizaBusquedaAvanzadaLentilla(
			...
			Session session,  String familia) {
	...
	public void validaBusquedasAvanzadas(BusquedaProductosForm formulario,
			Session session, boolean busqueda_avanzada, boolean busqueda_avanzada_lentilla) {
	...
	public void actualizaListas(Session session) {
