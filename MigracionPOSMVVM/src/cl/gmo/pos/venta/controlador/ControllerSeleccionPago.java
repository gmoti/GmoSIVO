...
public class ControllerSeleccionPago implements Serializable{
	...
	ValidaSeleccionPago validaSeleccionPago;
	...
	public void inicio(@ExecutionArgParam("cliente")ClienteBean arg,
		...
		rut="";
		validaSeleccionPago = new ValidaSeleccionPago();
		...
		if ((arg3 instanceof VentaPedidoForm) || (arg3 instanceof VentaDirectaForm)){			
			...
			//seleccionPagoForm.setListaFormasPago(validaSeleccionPago.postCarga(convenio, isapre, seleccionPagoForm.getDiferencia(), listaProductos,seleccionPagoForm));
		}
	...
	public void seleccionImpresion(@BindingParam("seleccion")String arg) {
		...
		if(arg.equals("G")) {	
			...
			if ((cadena.orElse("").trim()).equals("")) {
				Messagebox.show("Debe ingresar una raz�n social");	
				return;
			}
	...
	public void retornoNumeroDocumento(@BindingParam("num_documento")int num_documento, 
		...
		Messagebox.show("�Impresi�n correcta?","", 
				Messagebox.YES | 
				Messagebox.NO, 
	...
	//=================================================================
	//=========== Validaciones para el combo forma de pago ============
	//=================================================================
